...
function DemoHeader({
  ...
  return /* @__PURE__ */ jsxs2("header", { className: "flex items-center justify-between px-6 py-4 border-b-2 border-stone-200 bg-white sticky top-0 z-50 w-full shadow-vintage", children: [
