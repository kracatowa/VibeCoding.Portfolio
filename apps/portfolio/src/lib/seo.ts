...
const siteConfig = {
  ...
  description:
    'Développeur Web & Cloud Senior spécialisé en .NET, Azure et intégration de données. Plus de 5 ans d\'expérience dans le développement d\'applications d\'entreprise. Basé à Québec, QC.',
